...
console.log("##########Trying to import QRCodeScreen");
var {
  StyleSheet,
  View,
  Text,
...
var QRCodeScreen = React1.createClass({

  propTypes: {
    cancelButtonVisible: React1.PropTypes.bool,
    cancelButtonTitle: React1.PropTypes.string,
    onSucess: React1.PropTypes.func,
    onCancel: React1.PropTypes.func,
  },
...
var CancelButton = React1.createClass({
  render: function() {
    return (
